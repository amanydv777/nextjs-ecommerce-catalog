      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-1 max-w-2xl mx-4 hidden md:block">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2 pl-4 pr-12 bg-blue-50 border-none rounded-sm focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-700"
              />
              <button className="absolute right-0 top-0 h-full px-4 bg-blue-50 hover:bg-blue-100">
          ...
          <div className="flex items-center space-x-6">
            ...
            <Link href="/cart" className="flex items-center space-x-1 text-gray-700 hover:text-blue-600 transition-colors relative">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
